 ...
 */
public class Take_att extends Activity {
   ...
   // String course[] = {"asdf","asdfasdf"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                System.out.println("CorseID"+c_id);
                Intent intent = new Intent(Take_att.this,Students_attendance.class);
    ...
    class Select_course extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Take_att.this);
        ...
        { pDialog.dismiss();
            ...
            lv.setAdapter(new listAdapter1(Take_att.this,course_name,course_title, j));

            if (message != null)
            { Toast.makeText(Take_att.this, message, Toast.LENGTH_LONG).show(); }
        }
