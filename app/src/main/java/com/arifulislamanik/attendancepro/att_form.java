...
public class att_form extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(att_form.this);
...
//                String message = textMessage.getText().toString();
    ...
    class Select_students extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(att_form.this);
...
//                }
        ...
        { pDialog.dismiss();
           ...
           // String parcentage = Double.toString()
            ...
            if (message != null)
            { Toast.makeText(att_form.this, message, Toast.LENGTH_LONG).show(); }
        }
