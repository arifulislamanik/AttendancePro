...
public class JSONParser {
    ...
    public JSONObject getJSONFromUrl(final String url) {
        ...
        { Log.e("json Parsering", "" + e.toString()); } // Returning json Object.
        return jsonObj;
    }
    ...
    if(method == "POST"){ // now defaultHttpClient object
     DefaultHttpClient httpClient = new DefaultHttpClient();
     HttpPost httpPost = new HttpPost(url);
   ...
   catch (Exception e) { } // now will try to parse the string into JSON object
   try {
